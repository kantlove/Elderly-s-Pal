...
namespace NiceDreamers.Windows.Utilities
{
    ...
    internal class UserActivityRecord
    {
        ...
        public UserActivityRecord(SkeletonPoint position, int updateId, long timestamp)
        {
            ...
            IsActive = false;
            StateTransitionTimestamp = timestamp;
        }
        ...
        public double ActivityLevel
        {
            ...
            private set { activityLevel = Math.Max(0.0, Math.Min(1.0, value)); }
        }
        ...
        public void Update(SkeletonPoint position, int updateId, long timestamp)
        {
            ...
            ActivityLevel = ((1.0 - activityDecay) * ActivityLevel) + (activityDecay * newMetric);

            bool newIsActive = ActivityLevel >= ActivityMetricThreshold;
