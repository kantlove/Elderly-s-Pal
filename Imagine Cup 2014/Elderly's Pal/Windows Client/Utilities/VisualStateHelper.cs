...
namespace NiceDreamers.Windows.Utilities
{
    ...
    public class VisualStateHelper : DependencyObject
    {
        public static readonly DependencyProperty VisualStatePropertyProperty =
            DependencyProperty.RegisterAttached("VisualStateProperty", typeof (string), typeof (VisualStateHelper),
                new PropertyMetadata(VisualStateChanged));
        ...
        private static void VisualStateChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (null == elem)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture,
                    "Only objects of type {0} are supported", typeof (FrameworkElement).FullName));
            }
