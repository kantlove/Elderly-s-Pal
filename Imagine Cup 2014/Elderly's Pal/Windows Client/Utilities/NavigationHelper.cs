...
namespace NiceDreamers.Windows.Utilities
{
    ...
    public class NavigationHelper : DependencyObject
    {
        public static readonly DependencyProperty CurrentNavigationElementProperty =
            DependencyProperty.RegisterAttached("CurrentNavigationElement", typeof (object), typeof (NavigationHelper),
                new PropertyMetadata(CurrentNavigationElementChanged));
